  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center " >
        <div className="relative bg-white p-6 rounded-3xl shadow-2xl w-72 sm:w-80 border-4" style={{ borderColor: "#60340e" }} >
          {/* ===== Logout ===== */}
          {popup.type === "logout" && (
            <>
              ...
              <div className="flex justify-center gap-4">
                <button
                  ...
                  className="px-5 py-2 rounded-xl font-bold bg-[#60340e] text-white hover:bg-[#60340e]/80 hover:cursor-pointer"
                >
                  نعم
                </button>
                <button
